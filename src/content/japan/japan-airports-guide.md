---
title: "Narita and Haneda Airports: Getting Into Tokyo"
description: "Tokyo is served by two airports — Narita (international hub, 60km east) and Haneda (closer, increasingly international). A guide to the transport options from each airport to the city, costs, travel times, and how to choose the right route."
destination: Japan
category: Practical
publishDate: 2026-05-06
readingTime: 7
heroImage: /images/japan-airports-hero.jpg
tags: [Narita airport, Haneda airport, Tokyo airport, airport transfer, Narita Express, Limousine Bus, airport Japan, arriving Japan, NRT, HND, Tokyo transport]
city: tokyo
---
...
| Your hotel area | Best from Narita | Best from Haneda |
|----------------|-----------------|-----------------|
| Shinjuku, Harajuku | N'EX direct | Keikyu → transfer |
| Shibuya, Ebisu | N'EX direct | Keikyu → Shibuya |
| Asakusa, Ueno | Skyliner → Ueno/Nippori | Keikyu → Asakusa Line |
| Akihabara, Ginza | Skyliner → Ueno + transfer | Keikyu → Hibiya Line |
| Yokohama | N'EX direct | Keikyu direct |
