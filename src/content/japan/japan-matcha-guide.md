...
After harvest:
1. Leaves are steamed immediately to prevent oxidation (this step fixes the green color)
2. Dried and sorted — the leaf material separated from stems and veins (*tencha*)
3. Ground in stone mills (*ishiusu*) at a slow speed to prevent heat buildup — typically 30–40g per hour per stone mill
...
**Preparation (usucha)**:
1. Warm the bowl with hot water; discard
2. Sift 2g matcha into the warmed bowl
3. Add 70–80ml water at 70–80°C (not boiling)
4. Whisk in a W or M pattern rapidly until a thick foam forms
5. Drink immediately
