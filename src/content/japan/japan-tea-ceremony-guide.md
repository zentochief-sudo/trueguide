---
title: "The Japanese Tea Ceremony: A Visitor's Guide"
description: "The tea ceremony (chado) is a choreographed ritual for preparing and drinking matcha that encapsulates the core Japanese aesthetic principles of wabi-sabi, ma, and ichi-go ichi-e. A guide to what it is, where to experience it in Kyoto and Tokyo, and what to expect."
destination: Japan
category: Experiences
publishDate: 2026-05-06
readingTime: 8
heroImage: /images/japan-tea-ceremony-hero.jpg
tags: [tea ceremony, chado, matcha, wabi-sabi, Kyoto experiences, tea house, Sen no Rikyu, omotesenke, urasenke, Japanese culture, chashitsu, Japan experiences]
city: national
---

The Japanese tea ceremony (*chado*, 茶道, "the way of tea") is a choreographed ritual for preparing and drinking powdered green tea (*matcha*) that developed from 15th-century Zen Buddhist practices into one of the most philosophically dense cultural forms in Japanese history. It is not about the tea. Or rather: the tea is the occasion, and the occasion contains an entire aesthetic and philosophical system.
...
1. **Guests enter the roji garden** and wait in the *machiai* (waiting space) until the host appears
2. **The host greets guests** at the *naka-kuguri* gate with a bow; no words are spoken
3. **Entering the tea room**: Each guest examines the tokonoma scroll and flower arrangement
4. **Serving of wagashi** (Japanese sweets): Eaten before drinking, to balance the bitterness of the matcha
5. **Preparation of koicha** (thick tea, in formal gatherings): The host performs the choreographed preparation using the *chawan* (bowl), *chakin* (cloth), *chasen* (whisk), and *chashaku* (tea scoop)
6. **Drinking**: The bowl is turned twice clockwise before drinking (to avoid putting one's lips on the "front" of the bowl)
7. **Examination of implements**: Guests examine and discuss the tea bowl, whisk, and implements
8. **Usucha** (thin tea): A lighter preparation for each guest individually
9. **Departure**: Guest completes the closing bow ritual
